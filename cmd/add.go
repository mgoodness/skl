...
func newAddCmd() *cobra.Command {
	...
	cmd.Flags().StringSliceVarP(&skills, "skill", "s", nil, "skill(s) to install from a multi-skill source: comma-separated and/or repeated, supports \"*\" for every skill found (required when the source contains more than one skill)")
